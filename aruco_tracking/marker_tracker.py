  ...
  while(True):
    ...
    #   print(type(corners))
      ...
      for i, marker_id in enumerate(marker_ids):
        ...
        # cv2.line(input_frame, top_left, top_right, (0, 255, 0), 2)
        # cv2.line(input_frame, top_right, bottom_right, (0, 255, 0), 2)
        # cv2.line(input_frame, bottom_right, bottom_left, (0, 255, 0), 2)
        # cv2.line(input_frame, bottom_left, top_left, (0, 255, 0), 2)
        
        # center_x = int((top_left[0] + bottom_right[0]) / 2.0)
        # center_y = int((top_left[1] + bottom_right[1]) / 2.0)
        # cv2.circle(input_frame, (center_x, center_y), 4, (0, 0, 255), -1)
        # # print(marker_id, center_x, center_y)

        # color_pixel = (center_x, center_y)
        # print(color_pixel)
