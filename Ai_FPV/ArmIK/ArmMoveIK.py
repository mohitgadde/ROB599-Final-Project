...
if __name__ == "__main__":
    ...
    # print(AK.setPitchRangeMoving((-8, 20, 4), 0, -90,0, 1000))
    # time.sleep(1)
    # print(AK.setPitchRangeMoving((-10, 20, 4), 0, -90,0, 1000))
    # time.sleep(2)
    # print(AK.setPitchRangeMoving((-12, 20, 4), 0, -90,0, 1000))
    # time.sleep(1)
    # print(AK.setPitchRangeMoving((-12, 18, 4), 0, -90,0, 1000))
    ...
    # # setBusServoPulse(1, 200, 500)
    # AK.setPitchRangeMoving((5, 15, 7), 0, -90, 0, 1000)
    # time.sleep(3)
    # start=-500
    # ds=2
    # for i in range(20):
    #     start+=ds
    #     # setBusServoPulse(6, start, 500)
    #     # time.sleep(1)
    ...
    # # dy=0.5
    # for i in range(10):
    #     print(AK.setPitchRangeMoving((x_start, 15, 7), 0, -90, 0, 1000))
    #     x_start+=dx
    #     # y_start+=dy
    # time.sleep(3)
    # # x_start=5
    ...
    # dy=0.5
    # for i in range(10):
    #     print(AK.setPitchRangeMoving((5, y_start, 8), 0, -90, 0, 1000))
    #     # x_start+=dx
    #     y_start+=dy
    #     time.sleep(1.5)
    # print("End")

    # AK.drawMoveRange3D(-10, 10, 0.2, 10, 30, 0.2,-3,3,0.2,-90, 90, 1)
